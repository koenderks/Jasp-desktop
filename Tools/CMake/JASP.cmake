...
if(R_PKG_CELLAR_DOWNLOAD_REMOTE AND R_PKG_CELLAR_PATH STREQUAL "${CMAKE_BINARY_DIR}/_cache/cellar/" AND NOT EXISTS "${CMAKE_BINARY_DIR}/_cache/cellar/")
  ...
  if(R_PKG_CELLAR_REMOTE STREQUAL "")
    if(APPLE)
      SET(R_PKG_CELLAR_REMOTE "https://static.jasp-stats.org/development/cellars/cellar_macOS_x86_64_0.19.3.tar.gz")
      if(CMAKE_OSX_ARCHITECTURES STREQUAL "arm64")
        SET(R_PKG_CELLAR_REMOTE "https://static.jasp-stats.org/development/cellars/cellar_macOS_arm64_0.19.3.tar.gz")
      endif()
    elseif(WIN32)
      SET(R_PKG_CELLAR_REMOTE "https://static.jasp-stats.org/development/cellars/cellar_Windows_x86_64_0.19.3.tar.gz")
    endif()
  endif()
